...
[![DOI](https://img.shields.io/badge/DOI-10.1039/D5SC06406F-blue)](https://doi.org/10.1039/D5SC06406F)

For notes on the dataset and its usage, see the [Important Notes](#important-notes) section below.
...
## Important Notes
> [!Warning] Correction
> The reference solvation energies in hexadecane (Bronner et al.) have been corrected due to a transcription error in the experimental reference values. 
> While the individual affected entries are now corrected, this does not change the paper's reported mean errors, trends or overall conclusions.

- In the supporting information, the SMILES strings for every entry were generated by converting the coord.xyz file of the lowest energy conformer to the respective SMILES string.
- For details regarding the Solv models we refer to the original publication ([DOI](https://doi.org/10.1021/acs.jctc.3c00410)). When we refer to Solv we use the SPT-V formalism for the hard-sphere radii, Solv (PC) refers to the Pierotti–Claverie formalism and Solv (SPT-S) refers to the solute molecular surface formalism.

## Citiation
If you use FlexiSol or flexisol-cli in your research, please cite the following paper:

- L. Wittmann, C. E. Selzer, S. Grimme, *A diverse and chemically relevant solvation model benchmark set with flexible molecules and conformer ensembles*, *Chem. Sci.*, **2025**, 16, 22976-22995. ([DOI](https://doi.org/10.1039/D5SC06406F))

We provide a CITATION.bib file in this repository with the appropriate citation.