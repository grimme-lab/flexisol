...
## Important Notes
> [!WARNING]
> The reference values for solvation energies for molecules in hexadecane have been updated as they have been transcribed wrongly from the literature, however the source is the same. The correction does not change the paper's reported mean errors, trends or overall conclusions.
